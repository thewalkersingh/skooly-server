...
public class JwtUtil {
	...
	public String generateAccessToken(User user) {
		...
		return Jwts.builder()
		           .claims(claims)
		           .subject(user.getIdentity().getEmail() != null ? user.getIdentity().getEmail() :
									  user.getIdentity()
		                                                                                                .getPhone())   // email or phone as subject
		           .issuedAt(new Date())
	...
	public boolean isTokenValid(String token, User user) {
		try {
			...
			String userIdentifier = user.getIdentity().getEmail() != null ? user.getIdentity()
			                                                                    .getEmail() : user.getIdentity()
			                                                                                      .getPhone();
